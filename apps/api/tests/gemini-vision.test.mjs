...
const expected = { category: 'cup', subcategory: 'mug', brand_candidate: null, model_candidate: null,
  color: 'red', material: 'ceramic', style_attributes: [], visible_text: [], logos_markings: [],
  distinctive_features: [], hardware_details: [], shape_silhouette: [],
  search_terms: ['red ceramic mug'], confidence: 0.9, identity_confidence: 0 };
